...
#         self.det_conv0 = nn.Sequential(DSConv(4, 32, 3, 1, 1), nn.ReLU())
#         self.det_conv1 = nn.Sequential(DSConv(32, 32, 3, 1, 1), nn.ReLU(), DSConv(32, 32, 3, 1, 1), nn.ReLU())
#         self.det_conv2 = nn.Sequential(DSConv(32, 32, 3, 1, 1), nn.ReLU(), DSConv(32, 32, 3, 1, 1), nn.ReLU())
#         self.det_conv3 = nn.Sequential(DSConv(32, 32, 3, 1, 1), nn.ReLU(), DSConv(32, 32, 3, 1, 1), nn.ReLU())
#         self.det_conv4 = nn.Sequential(DSConv(32, 32, 3, 1, 1), nn.ReLU(), DSConv(32, 32, 3, 1, 1), nn.ReLU())
#         self.det_conv5 = nn.Sequential(DSConv(32, 32, 3, 1, 1), nn.ReLU(), DSConv(32, 32, 3, 1, 1), nn.ReLU())
